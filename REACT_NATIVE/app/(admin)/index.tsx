...
export default function AdminDashboard() {
  ...
  const cards = [
    ...
    { title: 'Contratos', value: '→', sub: 'gestión', route: '/(admin)/contratos', color: colors.primaryLight },
    { title: 'Pagos', value: '→', sub: 'cobros', route: '/(admin)/pagos', color: colors.accent },
    { title: 'Extras', value: '→', sub: 'catálogo', route: '/(admin)/extras', color: colors.success },
    { title: 'Usuarios', value: '→', sub: 'accesos', route: '/(admin)/usuarios', color: colors.danger },
  ];
