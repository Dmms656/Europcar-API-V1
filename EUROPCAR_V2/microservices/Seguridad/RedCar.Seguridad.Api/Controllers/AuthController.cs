...
/// <summary>Rutas compatibles con el SPA (antes monolito <c>/api/v1/Auth</c>).</summary>
[ApiController]
...
public sealed class AuthController : ControllerBase
{
    ...
    public async Task<IActionResult> Login([FromBody] LoginRequest request, CancellationToken ct)
    {
        ...
        {
            // 400 (no 401): el interceptor global de axios trata 401 como sesión inválida y limpia el token
            // incluso en /login.
    ...
    /// <summary>Hasta que MS.Clientes exponga consulta por cédula, devuelve false (no bloquea registro).</summary>
